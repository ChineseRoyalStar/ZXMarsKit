...
- (UIButton *)rightButton {
    ...
    if (!_rightButton) {
        ...
        //[_rightButton setTitleColor:UIColorFromRGBHex(0x5b5b5b) forState:UIControlStateNormal];
        //[_rightButton setTitleColor:UIColorFromRGBHex(0x5b5b5b) forState:UIControlStateHighlighted];
